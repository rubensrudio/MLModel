...
def test_create_saved_crossplot_analysis() -> None:
...
def test_list_saved_analyses_includes_created_analysis() -> None:
    client = TestClient(create_app())
...
def test_get_saved_analysis_by_id() -> None:
    client = TestClient(create_app())
...
def test_get_saved_analysis_returns_404_for_unknown_id() -> None:
    client = TestClient(create_app())
...
def test_create_saved_analysis_rejects_invalid_field() -> None:
    client = TestClient(create_app())
